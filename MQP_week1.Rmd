...
dat3_new<- cor(dat3, use = "complete.obs")
ggcorrplot(dat3_new, type="lower",
           title = "Correlations",
...
ggplot(dat4, aes(x=var1,y=reorder(names,var1)))+ #reorder in descending
  ...
  theme(panel.grid.major.x = element_blank(),
        ...
        panel.grid.major.y = element_line(linetype = "dotted", color = "red")) + labs(x="Variable 1", y="")
...
ggplot(dat5, aes(x=reorder(names,var1), y=var1))+
  geom_point()+
  geom_segment(aes(x=names, xend=names, y=0, yend=var1), color="dark green")+
...
ggplot(books_checked_out2, aes(y=reorder(Time1, Genre), x=Time1, xend=Time5))+
  geom_dumbbell(size=0.5, color="black", 
                colour_x = "red", colour_xend = "purple",size_xend = 3, size_x = 3) +
  labs(x="",y="Genre")
